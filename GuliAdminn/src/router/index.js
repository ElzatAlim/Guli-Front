...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      {
        path: 'video/:id',
        name: 'EduCourseVideoEdit',
        component: () => import('@/views/edu/course/video'),
        meta: { title: '编辑课程小节', noCache: true },
        hidden: true
      },
      {
        path: 'publish/:id',
  ...
  },
  {
    ...
    children: [
      {
        path: 'create',
        component: () => import('@/views/sta/create'), // Parent router-view
        name: '生成数据',
        meta: { title: '生成数据' },
      },
      {
